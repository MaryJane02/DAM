...
class GreetingProcessor : AbstractProcessor() {
    ...
    private fun generateKotlinWrapperClass(classElement: TypeElement, methods: MutableList<ExecutableElement>) {
        ...
        val classBuilder = TypeSpec.classBuilder(wrapperClassName)
            .primaryConstructor(FunSpec.constructorBuilder()
                ...
                .build())
            .addProperty(PropertySpec.builder("original", ClassName(packageName, originalClassName))
        ...
        for (method in methods) {
            ...
            val parameters = method.parameters.map{param -> ParameterSpec
                .builder(param.simpleName.toString(),
